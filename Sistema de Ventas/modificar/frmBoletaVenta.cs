...
using CapaNegocio;
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'Entidades' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
using Entidades;
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'Entidades' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
namespace CapaPresentacion
{
    public partial class frmBoletaVenta : Form
    {

#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'entUsuario' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        entUsuario us = null;
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'entUsuario' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        int id_user = 0;
        // int id_cliente = 0; // id_producto = 0;
        String ser, corr;
        // intancia clase global
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'AccionesEnControles' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        AccionesEnControles ac = new AccionesEnControles();
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'AccionesEnControles' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'entSerie' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        entSerie serie = new entSerie();
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'entSerie' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
...
#pragma warning disable CS0246 // El nombre del tipo o del espacio de nombres 'entProducto' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        private void CargarGrid(List<entProducto> Lista)
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'entProducto' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        {
            try
            {
